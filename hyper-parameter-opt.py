...
"""
This script is to generate a list of hyperparameters, run them on the model at zsl_task.py 
and print results and write them to a csv file
"""
...
for res in sorted_results:
    print "On {0:05}. iteration, With lr: {1:.3E} , reg_const: {2:.3E}," \
          " keep_prop: {3:.5f} -> final va_acc: {4:0.4f}, final unregularized loss: {5:09.5f} "\
